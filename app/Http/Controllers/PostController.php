...
class PostController extends Controller
{
    ...
    public function home(): View
    {
        ...
        // Показать 3 самых популярных поста на основе голосов "за"
        ...
        // Если разрешено — показывать рекомендуемые публикации на основе голосов пользователей.
        $user = auth()->user();
        ...
        } //Не авторизовано – популярные публикации на основе просмотров
        else {
            $recommendedPosts = Post::query()
        ...
        //Показать недавние категории с их последними постами
